...
- **Abstract**: Modify tokenization scheme to model the local structure information and design a better backbone architecture.
...
- **Methods**: A T2T-ViT consists of two main components:
