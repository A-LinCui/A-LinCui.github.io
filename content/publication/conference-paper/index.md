...
summary: Leverage the beneficial knowledge implicit in low-fidelity information (e.g., one-shot estimation, zero-shot estimation) to mitigate the "cold-start" problem of predictor-based NAS.
